...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        // TODO: what is the average birthday of some
        //  LocalDate birth = vday.plusWeeks(one conceived on Valentine's Day?
        ...
        LocalDatenye = LocalDate.of(2023, 1, 1);
    ...
    public static void testEarlyRetirement() {
       LocalDate bday = LocalDate.of(1987, 01, 01);
       LocalDate retirement =bday.plusYears(59).plusMonths(8);
    }
    ...
    public static void testLaborDay() {
        LocalDate jan1 = LocalDate.of(1987, 1, 1);
        LocalDate laborDay = jan1.with(TemporalAdjusters.nextOrSame(DayofWeek.MONDAY));
    }
